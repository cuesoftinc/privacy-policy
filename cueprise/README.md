...
| --- | --- | --- |
| Licensee data — records, files, people data a licensee or its users put into the platform | The licensee | Cuesoft |
...
2. Access inside Cuesoft is least-privilege and logged; personnel who can
   ...
   obligations.
3. Sub-processors (hosting and infrastructure providers) are engaged under
   contracts that impose the same protections; the licensing agreement
   states the current list and how licensees are told of changes.
...
example, you are an employee or customer of an organisation that runs
Cueprise™ — the organisation's own privacy notice governs, and rights
requests go to that organisation. We refer any request we receive about a
licensee's data to that licensee, and help them answer it.
