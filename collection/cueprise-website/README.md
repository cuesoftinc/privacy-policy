# cueprise.cuesoft.io — Cueprise™ product site

This page covers the **website** at cueprise.cuesoft.io. The Cueprise™
platform itself works differently, because inside a licensed deployment the
licensee rather than Cuesoft is the data controller — that is described in
the [Cueprise™ privacy notice](../../cueprise/).
...
- **Legal basis:** our legitimate interest in responding to the business
  ...
  [object](../../rights/your-rights/) at any time. Once a licence is signed,
  processing under it rests on the contract (Art. 6(1)(b)).
...
data terms and by the [Cueprise™ privacy notice](../../cueprise/).
