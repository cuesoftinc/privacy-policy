...
load and no analytics cookie is set until you press **Accept** in the consent
banner. Declining leaves the case studies and every link usable in full.

- **What Google receives after you accept:** a cookie or device identifier,
...
- **Withdraw:** use **Cookie preferences** in the site footer at any time.
  ...
  were already set.
- **Global Privacy Control:** an opt-out preference signal overrides a stored
  opt-in for as long as your browser sends it.
- **Legal basis:** consent (GDPR Art. 6(1)(a)); California treatment is set
  out on the [United States page](../../jurisdictions/united-states/).
